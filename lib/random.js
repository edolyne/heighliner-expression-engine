...
// Since we are linking this to a meteor application, we want our Ids to match
// what meteor builds. This file is taken from the Random package which is
// used to generate Id strings.
//
...
function createAleaGeneratorWithGeneratedSeed() {
  return new RandomGenerator(
    ...
    {seeds: [new Date, 1, 1, "", Math.random()]});
};
